...
df_clean <- df %>%
  # filter(State_Title != 'United States', !is.na(Region)) %>%
...
```{r}
(kable(contingency_region, format = "latex", caption = "Contingengy Table: Region Counts"))
```
